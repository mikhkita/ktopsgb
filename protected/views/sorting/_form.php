...
<?php $form=$this->beginWidget("CActiveForm", array(
	...
	<div class="row clearfix">
		...
		<?php echo $form->dropDownList($model, "correspondent_id", CHtml::listData(Correspondent::model()->sorted()->findAll(), 'id', 'name'), array("class" => "select2", "empty" => "Не задано", "required" => true)); ?>
