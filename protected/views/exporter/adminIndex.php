...
<table class="b-table" border="1">
	...
	<tr class="b-filter">
		...
		<td><?php echo CHtml::activeDropDownList($filter, 'group_id', CHtml::listData(ExporterGroup::model()->sorted()->findAll(), 'id', 'name'), array("class" => "select2", "empty" => "Все группы", "tabindex" => 2, "placeholder" => "Поиск группе")); ?></td>
