<? if( Yii::app()->user->checkAccess('updateReloc') ): ?><a href="<?php echo $this->createUrl("/".$this->adminMenu["cur"]->code."/adminCreate")?>" class="ajax-form ajax-create b-butt b-top-butt">Добавить</a><? endif; ?>
...
<table class="b-table" border="1">
	...
	<? foreach ($data as $i => $item): ?>
		<tr>
			...
			<td class="align-left"><? echo $item->price; ?></td>
			<td>
				<? if( Yii::app()->user->checkAccess('updateReloc') ): ?><a href="<?php echo Yii::app()->createUrl('/'.$this->adminMenu["cur"]->code.'/adminupdate',array('id'=>$item->id))?>" class="ajax-form ajax-update b-tool b-tool-update" title="Редактировать <?=$this->adminMenu["cur"]->vin_name?>"></a>
...
<div class="b-pagination-cont clearfix">
    ...
    <div class="b-lot-count">Всего пилорам: <?=$count?></div>
</div>
