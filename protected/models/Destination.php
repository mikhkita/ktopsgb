...
class Destination extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			"containers" => array(self::HAS_MANY, "Container", "destination_id"),
		);
	}
	...
	public function search($pages, $count = false)
	{
		...
		if( $count ){
			return Destination::model()->count($criteria);
		}else{
			return new CActiveDataProvider($this, array(
				"criteria" => $criteria,
				"pagination" => array("pageSize" => $pages, "route" => "destination/adminindex")
			));
		}
	}
