...
class Plant extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array("is_price", "numerical", "integerOnly" => true),
	...
	public function relations()
	{
		...
		return array(
			"boards" => array(self::HAS_MANY, "Board", "plant_id"),
		);
	}
	...
	public function search($pages, $count = false)
	{
		...
		$criteria->addSearchCondition("is_price", $this->is_price);

		if( $count ){
			return Plant::model()->count($criteria);
		}else{
			return new CActiveDataProvider($this, array(
				"criteria" => $criteria,
				"pagination" => array("pageSize" => $pages, "route" => "plant/adminindex")
			));
		}
	}
