...
class Exporter extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array("id, group_id, name, email", "safe", "on" => "search"),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			"group" => array(self::BELONGS_TO, "ExporterGroup", "group_id"),
		);
	}
	...
	public function search($pages, $count = false)
	{
		...
		$criteria->with = "group";
		$criteria->order = "group.sort ASC, t.name ASC";
