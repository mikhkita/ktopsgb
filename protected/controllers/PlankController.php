...
class PlankController extends Controller
{
	...
	public function actionAdminIndex($partial = false){
        ...
        $filter = new Plank('filter');

		if (isset($_GET['Plank'])){
            $filter->attributes = $_GET['Plank'];
        }
	...
	public function actionAdminCreate()
	{
		...
		if(isset($_POST["Plank"])) {
			if( $model->updateObj($_POST["Plank"]) ){
